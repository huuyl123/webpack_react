    ...
    <div>
      <div className="d-flex bg-main flex-column align-items-center pt-5 pb-5 pr-3 pl-3 rounded-0">
        <div className="w-100 text-light mb-4">
          <h1 className="lead f-3 text-center">W E L C O M E &nbsp;Minh Anh</h1>
        </div>
        <div className="w-100 d-flex text-light">
          <p className="col-6 pl-5">Name:</p>
          <p className="col-6 font-weight-light">Nguyen Minh Anh</p>
        </div>
        <div className="w-100 d-flex text-light">
        ...
        <div className="w-100 d-flex text-light">
          ...
          <p className="col-6 font-weight-light">150</p>
        </div>
        <div className="w-100 d-flex text-light">
          ...
          >
            MinhANguyen@gmail.com
          </a>
        </div>
        <div className="w-100 d-flex text-light">
          <p className="col-6 pl-5">Fach:</p>
          <p className="col-6 font-weight-light">Programmieren I</p>
        </div>
        <div className="w-100 d-flex text-light">
          <p className="col-6 pl-5">Create Date:</p>
          <p className="col-6 font-weight-light">30/2/2020</p>
        </div>
      </div>
